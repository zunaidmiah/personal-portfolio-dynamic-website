...
<head>
    ...
    <title>Forget password - Star Labs Portfolio Website</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">We get it, stuff happens. Just enter your current pasword and then 
                                            choose new password!</p>
                                    </div>
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="retype_password" placeholder="Enter re-type password...">
                                        </div>
