        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="portfolios" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">All Portfolios</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="recommendation" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Pending Recommendation</a>
                        <a class="collapse-item" href="#">All Recommendations</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="comment" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Pending Comments</a>
            ...
            <li class="nav-item">
                ...
                <div id="settings" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Forgot Password</a>
                        <a class="collapse-item" href="#">Log out</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="account" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">abc</a>
                        <a class="collapse-item" href="#">bbc</a>
                        <div class="collapse-divider"></div>
